...
<section class="headings">
    <div class="row">
        <div class="large-12 columns">
            <div class="breadcrumbs"><a href="fix-it.php">Fix.It</a></div>
...
<section class="light-grey-light std list-holder">
    <div class="row">
        <div class="large-6 columns">
            ...
            <ul>
                <li>
                    <div class="holder">
                        <h6><a href="fix-it-connecting-to-outlook-express.php">Connecting to Outlook Express</a></h6>
                        <p class="cite">about 14 hours ago by <a href="#">Connect.It</a></p>
                    </div>
                </li>
                <li>
                    <div class="holder">
                        <h6><a href="#">Help connecting to the network server</a></h6>
                        <p class="cite">about 14 hours ago by <a href="#">Connect.It</a></p>
                    </div>
                </li>
                <li>
