        ...
        <div class="row">
            <div class="large-12 columns">
                <form id="frmSearchProducts">
                    ...
                    <input autocomplete="off" autocorrect="off" autocapitalize="off" id="search" type="search" class="large no-margin" placeholder="Search training guides" />
                </form>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="large-4 columns">
                ...
                <div class="tile-bottom">
                    <a href="about-it-byod.php">Read Training Guide</a>
                </div>
            </div>
            ...
            <div class="large-4 columns">
                ...
                <div class="tile-bottom">
                    <a href="about-it-software-catalogue.php">Read Training Guide</a>
                </div>
            </div>
