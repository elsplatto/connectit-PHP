    ...
    setup: function() {
        ...
        var handler =  function(evt) {
            ...
            if (timer) {
                ...
                jQuery.event.simulate('scrollstart',_self, _args);
            }
    ...
    setup: function() {
        ...
        var handler = function(evt) {
            ...
            timer = setTimeout( function(){
                ...
                jQuery.event.simulate('scrollstop',_self, _args);
            }, jQuery.event.special.scrollstop.latency);
...
jQuery.event.special.scrollreachtop = {
    ...
    handler: function(evt) {
        ...
        if (parseInt(jQuery(this).scrollTop()) == 0 )
            jQuery.event.simulate('scrollreachtop',this, arguments);
    }
};
...
jQuery.event.special.scrollreachbottom = {
    ...
    handler: function(evt) {
        ...
        if (parseInt(jQuery(this).scrollTop()) >= scrollMaxTop )
            jQuery.event.simulate('scrollreachbottom', this, arguments);
    }
};