...
<section class="headings">
    <div class="row">
        <div class="large-12 columns">
            <div class="breadcrumbs"><a href="#">Level 1</a><a href="#">Level 2</a></div>
            <h1>Page Name</h1>
        </div>
    </div>
</section>
...
<section class="white std">
    <div class="row">
        <div class="large-12 columns">
            ...
            <p>
                (Body copy) Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi.
            </p>
