    ...
    <div class="row">
        ...
        <div class="large-4 columns right-col">
            ...
            <div class="tag-box light-grey-top-border">
                <a href="#" class="selected">Maths</a>
                <a href="#" class="selected">Robots</a>
                <a href="#" class="selected">Engaging</a>
                <a href="#" class="selected">Teaching</a>
                <a href="#" class="selected">Fun</a>
                <a href="#" class="selected">Technology</a>
            </div>
